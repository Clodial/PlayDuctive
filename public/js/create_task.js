...
$(function(){
    ...
    $("#userSelect").change(function() {
        ...
        if(addedUser!="") {
            ...
            document.getElementById("taskForm").appendChild(userElement);
            document.getElementById("taskForm").appendChild(document.createElement("br"));
